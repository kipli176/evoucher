...
<head>
    ...
    <!-- <link href="https://askbootstrap.com/preview/eatsome/vender/sidebar/demo.css" rel="stylesheet"> --> 
                ...
                <a href="search-list.html" class="text-decoration-none link-dark">
                    <div class="card rounded-4 shadow border-0 overflow-hidden">
                        <div class="position-relative">
                            ...
                            <div
                                class="product-off bg-primary p-2 rounded-2 shadow-sm position-absolute top-0 end-0 m-3">
                ...
                <a href="search-list.html" class="text-decoration-none link-dark">
                    <div class="card rounded-4 shadow border-0 overflow-hidden">
                        <div class="position-relative">
                            ...
                            <div class="product-back-two"><img src="/img/2.jpeg" alt class="img-fluid rounded-top">
                            </div>
